...
<center>	<input type="text" name="AP_SSID" value="<?php echo $ar['AP_SSID']; ?>" required><br></center>

<h4>Enter passphrase (8 to 20 alphanumeric characters)</h4>
<center>	<input type="text" name="AP_PASS" value="<?php echo $ar['AP_PASS']; ?>" pattern="^[A-Za-z0-9]{8,20}$" required><br></center>
